...
\begin{tikzpicture}
	...
	\begin{groupplot}[group style = { group size = 1 by 2 ,
			...
			\node[rectangle, draw] at (axis cs:2170,-6.5) {\Large BEGe};
			...
			% Bi212Tl208
			\addplot[const plot, purple] table[x=energy, y=Bi212Tl208fibers] {../data/resBEGe.dat};
			\addplot[const plot, cyan] table[x=energy, y=Bi212Tl208cables] {../data/resBEGe.dat};
			% Pb214Bi214
			\addplot[const plot, black, densely dashdotted] table[x=energy, y=Pb214Bi214fibers] {../data/resBEGe.dat};
			\addplot[const plot, green] table[x=energy, y=Pb214Bi214holder] {../data/resBEGe.dat};
			% other
			...
			\addplot[const plot, black] table[x=energy, y=Bi207minishroud] {../data/resBEGe.dat};
			%alpha
			\addplot[const plot, red,  densely dashdotted] table[x=energy, y=alpha] {../data/resBEGe.dat};
			\addplot[only marks, mark size = 0.8pt] table[x=midenergy, y=data] {../data/resBEGe.dat};
