...
\begin{tikzpicture}
	...
	\begin{groupplot}[group style = { group size = 1 by 2 ,
					...
					ylabel style = {at={(axis description cs:0.0,0.5)}},
					...
					\nextgroupplot[ytick = {-10,-5,0,5}, yticklabels = {$10^{-10}$,$10^{-5}$,$10^0$,$10^5$},
						...
						\node[rectangle, draw] at (axis cs:3000,-7) {\Large \textsc{coax}};
			...
			%\addplot[const plot, ] table[x=energy, y=Bi212Tl208cables] {../data/resCOAX.dat};
			% Pb214Bi214
			%\addplot[const plot, ] table[x=energy, y=Pb214Bi214fibers] {../data/resCOAX.dat};
			...
			\addplot[const plot, green!50!black] table[x=energy, y=Pa234cables] {../data/resCOAX.dat};
