...
\begin{tikzpicture}
	\begin{groupplot}[	group style = { group size = 1 by 3,
		...
		\nextgroupplot
			...
			\node[rectangle,draw,fill=white] at (axis cs:3500,3.8) {BEGes --- 15.05 kg$\cdot$yr};
		...
		\nextgroupplot
			...
			\node[rectangle,draw,fill=white] at (axis cs:3500,3.8) {enr coax --- 12.74 kg$\cdot$yr};
			\fill[green, opacity=0.5] (axis cs:2014,0) rectangle (axis cs:2064,4.7);
		\nextgroupplot
			...
			\node[rectangle,draw,fill=white] at (axis cs:3500,3.8) {nat coax --- 2.31 kg$\cdot$yr};
			\fill[green, opacity=0.5] (axis cs:2014,0) rectangle (axis cs:2064,4.7);
	\end{groupplot}
\end{tikzpicture}
\end{document}
