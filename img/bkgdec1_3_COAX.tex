...
\begin{tikzpicture}
	...
	\begin{groupplot}[group style = { group size = 1 by 2 ,
					...
					\nextgroupplot[ytick = {-10,-5,0,5}, yticklabels = {$10^{-10}$,$10^{-5}$,$10^0$,$10^5$},
						...
						\node[rectangle, draw] at (axis cs:4800,-7) {\Large \textsc{coax}};
						\addplot[const plot, blue, densely dashdotted] table[x=energy, y=K42nPlus] {../data/resCOAX.dat};
			...
			% Bi212Tl208
			\addplot[const plot, ] table[x=energy, y=Bi212Tl208fibers] {../data/resCOAX.dat};
			\addplot[const plot, green!50!black] table[x=energy, y=Bi212Tl208cables] {../data/resCOAX.dat};
			% Pb214Bi214
			\addplot[const plot, blue] table[x=energy, y=Pb214Bi214fibers] {../data/resCOAX.dat};
			\addplot[const plot, purple] table[x=energy, y=Pb214Bi214holder] {../data/resCOAX.dat};
			% other
			%\addplot[const plot, ] table[x=energy, y=Ac228holder] {../data/resCOAX.dat};
			%\addplot[const plot, orange] table[x=energy, y=Co60holder] {../data/resCOAX.dat};
