...
\begin{tikzpicture}
	...
	\begin{groupplot}[	group style = { group size = 2 by 2,
		...
		\nextgroupplot[xmax = 1500, ymin = -4,
						...
						legend entries = {\textsc{[h]}, \textsc{[ms]}, \textsc{[c]}, \textsc{[f]}$\cdot10^3$}
						]
			\addplot[const plot, draw = blue] file {../data/K40holder.dat};
			\addplot[const plot, draw = black!50!green] file {../data/K40minishroud.dat};
		...
		\nextgroupplot[xmax = 3500, ymin = -10,
						...
						%legend columns = 2,
						legend entries = {\textsc{[homLAr]}, \textsc{[ms]}, {[}n$^+${]}, {[}p$^+${]}}
						]
