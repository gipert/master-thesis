...
\begin{tikzpicture}
	\begin{groupplot}[group style = { group size = 1 by 2 ,
		...
		\nextgroupplot[ytick = {-5,0,5}, yticklabels = {$10^{-5}$,$10^0$,$10^5$},
			...
			\addplot[const plot, green] table[x=energy, y=Bi212Tl208cables] {../data/resBEGe.dat};
			% Pb214Bi214
			...
			%\addplot[const plot, orange] table[x=energy, y=Co60holder] {../data/resBEGe.dat};
			%\addplot[const plot, ] table[x=energy, y=Pa234cables] {../data/resBEGe.dat};
			%alpha
			\addplot[const plot, blue] table[x=energy, y=alpha] {../data/resBEGe.dat};
			\addplot[const plot, red] table[x=energy, y=sum] {../data/resBEGe.dat};
			\addplot[only marks, mark size = 0.5pt] table[x=midenergy, y=data] {../data/resBEGe.dat};

		\nextgroupplot[width = 15cm, height = 4cm]
