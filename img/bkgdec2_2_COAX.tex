...
\begin{tikzpicture}
	...
	\begin{groupplot}[group style = { group size = 1 by 2 ,
				...
				\node[rectangle, draw] at (axis cs:2300,-10) {\Large \textsc{coax}};
			...
			% Bi212Tl208
			\addplot[const plot, orange] table[x=energy, y=Bi212Tl208fibers] {../data/resCOAX.dat};
			\addplot[const plot, violet] table[x=energy, y=Bi212Tl208cables] {../data/resCOAX.dat};
			% Pb214Bi214
			\addplot[const plot, green!50!black] table[x=energy, y=Pb214Bi214fibers] {../data/resCOAX.dat};
