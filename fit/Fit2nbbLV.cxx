...
Fit2nbbLV::Fit2nbbLV(std::string name) : BCModel(name.c_str()), kUseRange(false) {
    ...
    /* [6] */  this->AddParameter("alphaBEGe",            8E02, 1.5E03);
    /* [7] */  this->AddParameter("alphaCOAX",            2E03, 3E03);
    ...
    /* [12] */ this->AddParameter("Ac228holder",          0, 7E-04);
    /* [13] */ this->AddParameter("Co60holder",           0, 3E-04);
    /* [14] */ this->AddParameter("K40holder",            0, 2E-02);
    /* [15] */ this->AddParameter("Bi212Tl208holder",     0, 7E-04);
    /* [16] */ this->AddParameter("Pb214Bi214holder",     0, 3E01);
    /* [17] */ this->AddParameter("K40cable",             0, 1E00);
    /* [18] */ this->AddParameter("Bi212Tl208cables",     0, 5E-02);
    /* [19] */ this->AddParameter("Pb214Bi214cables",     0, 1E03);
    ...
    /* [27] */ this->AddParameter("Pa234cables",          0, 1E07);
    /* [28] */ this->AddParameter("Pa234holder",          0, 1E05);
