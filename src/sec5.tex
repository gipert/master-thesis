...
\begin{table}
	\caption{Results for the minimal background model with non-informative priors. The units are mBq/kg if not specified after the source name. Upper limits are given at 90\% C.L. The background index field is left blank when the Q-value of the background source is below the \textsc{RoI}.}
	\centerline{%
	\begin{tabular}{lccccc}
		...
		\cmidrule{1-6}
		\textsc{fibers}					&			&			&						&			&			\\
		\ce{^{40}K}						&	94		&	88		&	$^{+13}_{-15}$		&	--		&	--		\\
		\ce{^{212}Bi} + \ce{^{208}Tl}	&	1.3		&	2.1		&	$^{+2.1}_{-1.6}$	&	0.04	&	0.04	\\
		\ce{^{214}Pb} + \ce{^{214}Bi}	&	1.58	&	2.07	&	$^{+0.63}_{-0.77}$	&	0.13	&	0.15	\\
		\cmidrule{1-6}
		\textsc{holders}				&			&			&						&			&			\\
		\ce{^{40}K}						&	4.8		&	2.1		&	$^{+2.1}_{-1.9}$	&	--		&	--		\\
		\ce{^{214}Pb} + \ce{^{214}Bi}	&	0.108	&	0.049	&	$^{+0.064}_{-0.052}$&	0.12	&	0.08	\\
		\ce{^{228}Ac}					&	0.314	&	0.321	&	$\pm0.075$			&	0.005	&	0.005	\\
		\ce{^{60}Co}					&	0.110	&	0.098	&	$\pm0.025$			&	0.06	&	0.04	\\
		\cmidrule{1-6}
		\textsc{cables}					&			&			&						&			&			\\
		\ce{^{40}K}						&	--		&	$<300$	&	--					&	--		&	--		\\
		\ce{^{212}Bi} + \ce{^{208}Tl}	&	10.7	&	9.5		&	$^{+2.6}_{-3.0}$	&	0.2		&	0.2		\\
		\ce{^{234\text{m}}Pa}			&	7.0		&	5.7		&	$^{+4.3}_{-3.8}$	&	0.002	&	0.003	\\
		\cmidrule{1-6}
		\textsc{mini-shroud}			&			&			&						&			&			\\
		\ce{^{207}Bi}					&	0.72	&	0.59	&	$^{+0.44}_{-0.38}$	&	0.001	&	0.004	\\
		\cmidrule{1-6}
		\textsc{other}					&			&			&						&			&			\\
...
\begin{table}
	\caption{Results for the minimal background model with informative priors. The units are mBq/kg if not specified after the source name. The background index field is left blank when the Q-value of the background source is below the \textsc{RoI}.}
	\centerline{%
	\begin{tabular}{lccccc}
		\toprule
		\multirow{2}{*}{Source}			&	Global	&	Marg.	&	1$\sigma$	&	BI [BEGe]	&	BI [\textsc{coax}]	\\
										&	[mBq/kg]&	[mBq/kg]&	[mBq/kg]	& \multicolumn{2}{c}{[$10^{-2}$cts/(keV$\cdot$kg$\cdot$yr)]}	\\
		\midrule
		$T_{1/2}^{2\nu}$ [$10^{21}$ yr]	&	1.984	&	1.980	&	$\pm0.020$			&	0.001	&	0.001	\\
		\cmidrule{1-6}
		\textsc{fibers}					&			&			&						&			&			\\
		\ce{^{40}K}						&	89.71	&	88.65	&	$^{+11}_{-14}$		&	--		&	--		\\
		\ce{^{212}Bi} + \ce{^{208}Tl}	&	0.0583	&	0.0595	&	$\pm0.012$			&	0.002	&	0.002	\\
		\ce{^{214}Pb} + \ce{^{214}Bi}	&	2.08	&	2.13	&	$^{+0.64}_{-0.77}$	&	0.1		&	0.2		\\
		\cmidrule{1-6}
		\textsc{holders}				&			&			&						&			&			\\
		\ce{^{40}K}						&	4.00	&	4.17	&	$0.83$				&	--		&	--		\\
		\ce{^{214}Pb} + \ce{^{214}Bi}	&	0.064	&	0.052	&	$^{+0.065}_{-0.052}$&	0.08	&	0.06	\\
		\ce{^{228}Ac}					&	0.315	&	0.305	&	$\pm0.075$			&	0.005	&	0.005	\\
		\ce{^{60}Co}					&	0.086	&	0.099	&	$\pm0.025$			&	0.05	&	0.04	\\
		\cmidrule{1-6}
		\textsc{cables}					&			&			&						&			&			\\
		\ce{^{40}K}						&	79		&	46		&	$^{+89}_{-63}$		&	--		&	--		\\
		\ce{^{212}Bi} + \ce{^{208}Tl}	&	12.1	&	11.9	&	$\pm1.6$			&	0.29	&	0.23	\\
		\ce{^{234\text{m}}Pa}			&	7.2		&	6.0		&	$^{+4.3}_{-3.8}$	&	0.002	&	0.002	\\
		\cmidrule{1-6}
		\textsc{mini-shroud}			&			&			&						&			&			\\
		\ce{^{207}Bi}					&	0.50	&	0.56	&	$^{+0.44}_{-0.37}$	&	0.001	&	0.003	\\
		\cmidrule{1-6}
		\textsc{other}					&			&			&						&			&			\\
		\ce{^{42}K} in LAr				&	0.2019	&	0.2004	&	$\pm0.0038$			&	0.38	&	0.47	\\
