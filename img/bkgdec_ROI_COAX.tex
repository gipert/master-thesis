...
\begin{tikzpicture}
	...
	\begin{groupplot}[group style = { group size = 1 by 2 ,
					...
					\nextgroupplot[ytick = {-10,-5,0,5}, yticklabels = {$10^{-10}$,$10^{-5}$,$10^0$,$10^5$},
						...
						\node[rectangle, draw] at (axis cs:2170,-6.5) {\Large \textsc{coax}};
			\addplot[const plot, blue] table[x=energy, y=2nbb] {../data/resCOAX.dat};
			\addplot[const plot, black!50!green] table[x=energy, y=K42homLAr] {../data/resCOAX.dat};
			\addplot[const plot, cyan, densely dashdotted] table[x=energy, y=K42nPlus] {../data/resCOAX.dat};
			% K40 
			...
			% Bi212Tl208
			\addplot[const plot, purple] table[x=energy, y=Bi212Tl208fibers] {../data/resCOAX.dat};
			\addplot[const plot, cyan] table[x=energy, y=Bi212Tl208cables] {../data/resCOAX.dat};
			% Pb214Bi214
			\addplot[const plot, black, densely dashdotted] table[x=energy, y=Pb214Bi214fibers] {../data/resCOAX.dat};
			\addplot[const plot, green] table[x=energy, y=Pb214Bi214holder] {../data/resCOAX.dat};
			% other
			\addplot[const plot, orange] table[x=energy, y=Ac228holder] {../data/resCOAX.dat};
			\addplot[const plot, violet] table[x=energy, y=Co60holder] {../data/resCOAX.dat};
			\addplot[const plot, blue, densely dashdotted] table[x=energy, y=Pa234cables] {../data/resCOAX.dat};
			\addplot[const plot, black] table[x=energy, y=Bi207minishroud] {../data/resCOAX.dat};
			%alpha
			\addplot[const plot, red,  densely dashdotted] table[x=energy, y=alpha] {../data/resCOAX.dat};
			\addplot[only marks, mark size = 0.8pt] table[x=midenergy, y=data] {../data/resCOAX.dat};
			\addplot[const plot, red, thick] table[x=energy, y=sum] {../data/resCOAX.dat};
			\draw[fill=blue, draw=none, opacity=0.2] (axis cs:2014,-100) rectangle (axis cs:2064,10);
				\addlegendentry{$2\nu\beta\beta$}
				\addlegendentry{\ce{^{42}K} \textsc{[homLAr]}};
				\addlegendentry{\ce{^{42}K} \textsc{[n$^+$]}};
		...
		\nextgroupplot[width = 20cm, height = 4cm]
			...
			\draw[fill=blue, opacity=0.2] (axis cs:2014,-100) rectangle (axis cs:2064,100);
	\end{groupplot}
\end{tikzpicture}
\end{document}
